...
const Line1 = "Use 'f' to move to a character to the RIGHT of the cursor."
const Line2 = "And use 'F' to move to a character to the LEFT."
...
const Line6 = "And use ',' to repeat the last f, t, F, or T in the opposite direction."
...
export class InlineFindingTutorial implements ITutorial {
    ...
    constructor() {
        this._stages = [
            ...
            new Stages.MoveToGoalStage("Move to the 'R' in 'RIGHT' using 'fR'", 0, 38),
            new Stages.SetBufferStage([Line1, Line2]),
            new Stages.MoveToGoalStage("Use 'j' to move down a line", 1, 38),
            new Stages.MoveToGoalStage("Use 'F' to move LEFT to the goal", 1, 9),
            new Stages.SetBufferStage([Line1, Line2, Line3]),
            new Stages.MoveToGoalStage("Use 'j' to move down a line", 2, 9),
            new Stages.MoveToGoalStage("Use 't' to move to the goal", 2, 43),
            new Stages.SetBufferStage([Line1, Line2, Line3, Line4]),
            new Stages.MoveToGoalStage("Use 'j' to move down a line", 3, 43),
            new Stages.MoveToGoalStage("Use 'T' to move to the goal", 3, 6),
            new Stages.SetBufferStage([Line1, Line2, Line3, Line4, Line5]),
            new Stages.MoveToGoalStage("Use 'j' to move down a line", 4, 6),
