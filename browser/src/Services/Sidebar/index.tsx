...
import { SidebarPane, ContainerWidget, ItemWidget, LabelWidget } from "./SidebarPane"
...
export const activate = (configuration: Configuration) => {
    ...
    if (configuration.getValue("experimental.sidebar.enabled")) {
        ...
        searchPane.set([new ContainerWidget(), new LabelWidget(), new LabelWidget(), new ItemWidget("oni.test"), new ItemWidget("oni.test2")])
    }
}
