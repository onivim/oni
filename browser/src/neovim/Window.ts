...
export interface IWindow {
    ...
    getDimensions(): Q.Promise<WindowDimensions>
}
...
export interface WindowDimensions extends WindowPosition {
    width: number
    height: number
}
...
export class Window implements IWindow {
    ...
    public getPosition(): Q.Promise<WindowPosition> {
    ...
    public getDimensions(): Q.Promise<WindowDimensions> {
