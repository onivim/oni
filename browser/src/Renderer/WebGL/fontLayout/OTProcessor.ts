...
export default class OTProcessor {
    ...
    constructor(font: { _variationProcessor: { normalizedCoords: any } }, table: any) {
        this.font = font
        this.table = table
    ...
    selectScript(script?: any, language?: any, direction?: any) {
        let changed = false
        let entry
    ...
    lookupsForFeatures(userFeatures: any[] = [], exclude?: any) {
        let lookups = []
    ...
    substituteFeatureForVariations(featureIndex: any) {
    ...
    findVariationsIndex(coords: any) {
    ...
    variationConditionsMatch(conditions: any, coords: any) {
    ...
    applyFeatures(userFeatures: any[], glyphs: any[], advances: any) {
        let lookups = this.lookupsForFeatures(userFeatures)
        this.applyLookups(lookups, glyphs, advances)
    }

    applyLookups(
        lookups: { feature: any; index: any; lookup: any }[],
        glyphs: any,
        positions: any,
    ) {
        this.glyphs = glyphs
    ...
    applyLookup(lookup: any, table: any) {
        throw new Error("applyLookup must be implemented by subclasses")
    }

    applyLookupList(lookupRecords: any) {
    ...
    coverageIndex(coverage: any, glyph?: any) {
        if (glyph == null) {
    ...
    match(
        sequenceIndex: any,
        sequence: any,
        fn: (component: any, glyph: any) => boolean,
        matched?: any[],
    ) {
    ...
    sequenceMatches(sequenceIndex: any, sequence: any) {
        return this.match(sequenceIndex, sequence, (component, glyph) => component === glyph.id)
    }

    sequenceMatchIndices(sequenceIndex: number, sequence: any) {
        return this.match(
            sequenceIndex,
            sequence,
            (component, glyph) => {
    ...
    coverageSequenceMatches(sequenceIndex: any, sequence: any) {
        return this.match(
            sequenceIndex,
            sequence,
    ...
    getClassID(glyph: any, classDef: any) {
    ...
    classSequenceMatches(sequenceIndex: any, sequence: any, classDef: any) {
        return this.match(
            sequenceIndex,
            sequence,
            ...
            case 2:
                ...
                for (let rule of set) {
                    if (this.classSequenceMatches(1, rule.classes, table.classDef)) {
                        // CUSTOM INSERTION
                        this.updateContextGroupsInSequence(-1, table.classDef.length + 1)
                        // CUSTOM INSERTION
                        return this.applyLookupList(rule.lookupRecords)
                    }
                }
    ...
    applyChainingContext(table: any) {
        switch (table.version) {
            case 1:
                let index = this.coverageIndex(table.coverage)
                if (index === -1) {
